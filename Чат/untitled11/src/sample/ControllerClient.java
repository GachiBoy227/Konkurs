    ...
    void initialize() {
        ...
        CreateClient.setOnAction(e->{
            ...
            Thread client=new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ControllerClient.client = new Client(EditIP.getText(), Integer.parseInt(EditPort.getText()), ServerChat,ClientSend,Waiting);
                    }
                    catch (Exception e){
                        Waiting.setVisible(true);
                    }
        ...
        ClientSendButton.setOnAction(e->{
            client.send(ClientSend.getText());
            ClientSend.setText("");
        });
    }
